...
export default function AcademicHeader({ student, subjects, totalAssessments, t }: AcademicHeaderProps) {
      ...
      <div className="flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <span className={`inline-flex items-center rounded-full border px-3 py-1 text-sm font-semibold ${getLevelColor(overall)}`}>
